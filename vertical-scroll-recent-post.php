...
function vsrp_control() 
{
    ...
    Plug-in created by <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-recent-post/'>Gopi</a>. <br />
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-recent-post/'>click here</a> to post suggestion or comments or feedback.   <br /> 
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-recent-post/'>click here</a> to see LIVE demo.   <br /> 
...
function vsrp_admin_options() 
{
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="3"><tr><td width="54%" align="left">
	<?php
	...
	<td width="46%" align="left" valign="middle" style="border-left:dotted;padding-left:10px;">
    ...
    <hr />
	<h2><?php echo wp_specialchars( 'Plugin' ); ?></h2>
    ...
    <h2><?php echo wp_specialchars( 'About Plugin' ); ?></h2>
    Plug-in created by <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-recent-post/'>Gopi</a>. <br />
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-recent-post/'>click here</a> to post suggestion or comments or how to improve this plugin.   <br /> 
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-recent-post/'>click here</a> to see LIVE demo.   <br /> 
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-recent-post/'>click here</a> To download my other plugins. <br><br> 
