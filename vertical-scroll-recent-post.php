...
function vsrp() 
{
	...
	if ( ! empty($vsrp_data) ) 
	{
		...
		foreach ( $vsrp_data as $vsrp_data ) 
		{
			...
			$vsrp_post_title = substr($vsrp_post_title, 0, 100);
...
function vsrp_install() 
{
	...
	add_option('vsrp_dis_num_height', "45");
...
function vsrp_admin_options() 
{
    ...
    <h2><?php echo wp_specialchars( 'About Plugin' ); ?></h2>
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-recent-post/'>click here</a> to post suggestion and comments.<br /> 
    <a target="_blank" href='http://www.gopiplus.com/work/2010/07/18/vertical-scroll-recent-post/'>click here</a> to see live demo.   <br /> 
