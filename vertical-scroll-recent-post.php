...
function vsrp_admin_options() 
{
    ...
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/07/18/vertical-scroll-recent-post/'>click here</a> to post suggestion or comments or how to improve this plugin.  <br /> 
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/07/18/vertical-scroll-recent-post/'>click here</a> to see LIVE demo.  <br /> 
    <a target="_blank" href='http://gopi.coolpage.biz/demo/2009/07/18/vertical-scroll-recent-post/'>click here</a> To download my other plugins.  <br /> 
...
{
	add_options_page('Software Game Movie 3D | Vertical scroll recent post', 'Vertical scroll recent post', 7, __FILE__, 'vsrp_admin_options' );
}
